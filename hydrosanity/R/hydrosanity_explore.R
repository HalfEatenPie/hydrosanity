...
.hs_on_explore_seasonal_button_clicked <- function(button) {
	...
	id.cmd$labels <- rep(format(tmp.data$Time, "%Y"), nBlobs)
	.hydrosanity$id.call[["seasonality"]] <<- id.cmd
